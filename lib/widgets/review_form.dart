              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    if (value == null ||
                        value.isEmpty ||
                        value.trim().isEmpty) {
                      return AppLocalizations.of(context)!.enterLocationError;
                    }
                    return null;
                  },
                ),
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                      ...
                      border: const OutlineInputBorder(),
                      labelText:
                          AppLocalizations.of(context)!.foodAvailableComma),
                  validator: (value) {
                    if (value == null ||
                        value.isEmpty ||
                        value.trim().isEmpty) {
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                      ...
                      border: const OutlineInputBorder(),
                      labelText:
                          AppLocalizations.of(context)!.additionalReview),
                ),
                const SizedBox(height: 16),
                //-----Categories-----
                Wrap(
                ...
                ElevatedButton(
                  onPressed: () async {
                    if (_formKey.currentState!.validate()) {
                      final restaurantName =
                          restaurantNameController.value.text.trim();
                      ...
                      final additionalReview =
                          reviewController.value.text.trim();
                      final selectedCategories = _selectedCategories;
                      final createdTime =
                          widget.review?.createdTime ?? DateTime.now();
                  ...
                  child: Text(widget.review == null
                      ? AppLocalizations.of(context)!.addReviewButton
                      : AppLocalizations.of(context)!.editReviewButton),
                ),
              ],
            ),
          )),
